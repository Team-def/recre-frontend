...
import { catchStartAtom } from "@/app/modules/catchStartAtom";
import { useAtom } from "jotai";

const Particle = () => {
    const [catchStart, setCatchStart] = useAtom(catchStartAtom)
